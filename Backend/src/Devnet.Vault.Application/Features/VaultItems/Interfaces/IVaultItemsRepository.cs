...
public interface IVaultItemsRepository
{
    ...
    Task<bool> IsGroupValidForItems(long groupId, long ownerId, CancellationToken cancellationToken);
    ...
    Task<bool> MoveEntryToNewGroup(long entryId, long? newGroupId, long ownerId, long updatedBy, CancellationToken cancellationToken);
}
